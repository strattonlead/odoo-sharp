...
namespace OdooSharp.Models
{
    ...
    public partial class SaleOrderTemplate
    {
        ...
        /// <summary>
        /// <para>Name: Confirmation Mail</para>
        ...
        /// <summary>
        /// <para>Name: Quotation Duration</para>
        /// <para>Internal: number_of_days</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: sale_order_template_line_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: sale.order.template.line</para>
        /// </summary>
        [JsonPropertyName("sale_order_template_line_ids")]
        [OdooField("sale_order_template_line_ids")]
        public List<int> SaleOrderTemplateLineIds { get; set; }

        /// <summary>
        /// <para>Name: Optional Products</para>
        /// <para>Internal: sale_order_template_option_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: sale.order.template.option</para>
        /// </summary>
        [JsonPropertyName("sale_order_template_option_ids")]
        [OdooField("sale_order_template_option_ids")]
        public List<int> SaleOrderTemplateOptionIds { get; set; }
        ...
        /// <summary>
        /// <para>Name: Headers and footers</para>
