...
{
    [OdooModel("account.analytic.applicability")]
    public partial class AccountAnalyticApplicability
    {
        ...
        /// <summary>
        /// <para>Name: Analytic Plan</para>
        /// <para>Internal: analytic_plan_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        ...
        /// <para>Internal: business_domain</para>
        /// <para>Store: yes</para>
        ...
        /// <summary>
        /// <para>Name: Financial Accounts Prefixes</para>
        ...
        /// <summary>
        /// <para>Name: Display Account Prefix</para>
        /// <para>Internal: display_account_prefix</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Account Prefix Placeholder</para>
        /// <para>Internal: account_prefix_placeholder</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
