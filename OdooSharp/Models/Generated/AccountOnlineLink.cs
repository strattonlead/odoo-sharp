...
namespace OdooSharp.Models
{
    ...
    public partial class AccountOnlineLink
    {
        ...
        /// <para>Internal: account_online_account_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("account_online_account_ids")]
        public List<int> AccountOnlineAccountIds { get; set; }

        /// <summary>
        /// <para>Name: Last Refresh</para>
        /// <para>Internal: last_refresh</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Next synchronization</para>
        /// <para>Internal: next_refresh</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Connection State Details</para>
        /// <para>Internal: connection_state_details</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("connection_state_details")]
        [JsonConverter(typeof(OdooFlexibleJsonObjectConverter))]
        public object ConnectionStateDetails { get; set; }

        /// <summary>
        /// <para>Name: Automatic synchronization</para>
        /// <para>Internal: auto_sync</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Has Unlinked Accounts</para>
        /// <para>Internal: has_unlinked_accounts</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("has_unlinked_accounts")]
        public bool HasUnlinkedAccounts { get; set; }
        ...
        /// <para>Internal: refresh_token</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Provider Data</para>
        /// <para>Internal: provider_data</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Provider Type</para>
        /// <para>Internal: provider_type</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
