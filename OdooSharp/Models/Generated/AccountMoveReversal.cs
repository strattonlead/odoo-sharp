...
{
    [OdooModel("account.move.reversal")]
    public partial class AccountMoveReversal
    {
        ...
        /// <summary>
        /// <para>Name: New Move</para>
        /// <para>Internal: new_move_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: account.move</para>
        /// </summary>
        [JsonPropertyName("new_move_ids")]
        [OdooField("new_move_ids")]
        public List<int> NewMoveIds { get; set; }
        ...
        /// <summary>
        /// <para>Name: Reason displayed on Credit Note</para>
        ...
        /// <summary>
        /// <para>Name: Residual</para>
        /// <para>Internal: residual</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
