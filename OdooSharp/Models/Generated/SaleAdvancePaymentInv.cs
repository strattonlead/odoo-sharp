...
{
    [OdooModel("sale.advance.payment.inv")]
    public partial class SaleAdvancePaymentInv
    {
        ...
        /// <summary>
        /// <para>Name: Create Invoice</para>
        /// <para>Internal: advance_payment_method</para>
        /// <para>Store: yes</para>
        ...
        /// <summary>
        /// <para>Name: Has down payments</para>
        /// <para>Internal: has_down_payments</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Deduct down payments</para>
        /// <para>Internal: deduct_down_payments</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Down Payment Amount (Fixed)</para>
        /// <para>Internal: fixed_amount</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Display Draft Invoice Warning</para>
        /// <para>Internal: display_draft_invoice_warning</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Consolidated Billing</para>
        /// <para>Internal: consolidated_billing</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
