...
{
    [OdooModel("account.analytic.distribution.model")]
    public partial class AccountAnalyticDistributionModel
    {
        ...
        /// <summary>
        /// <para>Name: Partner Category</para>
        /// <para>Internal: partner_category_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("partner_category_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        ...
        /// <summary>
        /// <para>Name: Accounts Prefix</para>
        /// <para>Internal: account_prefix</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Prefix Placeholder</para>
        /// <para>Internal: prefix_placeholder</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("prefix_placeholder")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string PrefixPlaceholder { get; set; }
