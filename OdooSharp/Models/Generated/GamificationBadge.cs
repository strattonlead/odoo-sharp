...
namespace OdooSharp.Models
{
    ...
    public partial class GamificationBadge
    {
        ...
        /// <summary>
        /// <para>Name: Forum Badge Level</para>
        /// <para>Internal: level</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Allowance to Grant</para>
        /// <para>Internal: rule_auth</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [everyone]=Everyone,[users]=A selected list of users,[having]=People having some badges,[nobody]=No one, assigned through challenges</para>
        /// </summary>
        [JsonPropertyName("rule_auth")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("rule_auth")]
        public string RuleAuth { get; set; }

        /// <summary>
        /// <para>Name: Authorized Users</para>
        /// <para>Internal: rule_auth_user_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("rule_auth_user_ids")]
        [OdooField("rule_auth_user_ids")]
        public List<int> RuleAuthUserIds { get; set; }

        /// <summary>
        /// <para>Name: Required Badges</para>
        /// <para>Internal: rule_auth_badge_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("rule_auth_badge_ids")]
        [OdooField("rule_auth_badge_ids")]
        public List<int> RuleAuthBadgeIds { get; set; }

        /// <summary>
        /// <para>Name: Monthly Limited Sending</para>
        /// <para>Internal: rule_max</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("rule_max")]
        [OdooField("rule_max")]
        public bool RuleMax { get; set; }

        /// <summary>
        /// <para>Name: Limitation Number</para>
        /// <para>Internal: rule_max_number</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("rule_max_number")]
        [OdooField("rule_max_number")]
        public int RuleMaxNumber { get; set; }

        /// <summary>
        /// <para>Name: Reward of Challenges</para>
        /// <para>Internal: challenge_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("challenge_ids")]
        public List<int> ChallengeIds { get; set; }

        /// <summary>
        /// <para>Name: Rewarded by</para>
        /// <para>Internal: goal_definition_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("goal_definition_ids")]
        [OdooField("goal_definition_ids")]
        public List<int> GoalDefinitionIds { get; set; }

        /// <summary>
        /// <para>Name: Owners</para>
        /// <para>Internal: owner_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: granted_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("granted_count")]
        [OdooField("granted_count")]
        public int GrantedCount { get; set; }

        /// <summary>
        /// <para>Name: Number of users</para>
        /// <para>Internal: granted_users_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("granted_users_count")]
        [OdooField("granted_users_count")]
        public int GrantedUsersCount { get; set; }

        /// <summary>
        /// <para>Name: Unique Owners</para>
        /// <para>Internal: unique_owner_ids</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: res.users</para>
        /// </summary>
        [JsonPropertyName("unique_owner_ids")]
        [OdooField("unique_owner_ids")]
        public List<int> UniqueOwnerIds { get; set; }

        /// <summary>
        /// <para>Name: Monthly total</para>
        /// <para>Internal: stat_this_month</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("stat_this_month")]
        [OdooField("stat_this_month")]
        public int StatThisMonth { get; set; }

        /// <summary>
        /// <para>Name: My Total</para>
        /// <para>Internal: stat_my</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("stat_my")]
        [OdooField("stat_my")]
        public int StatMy { get; set; }

        /// <summary>
        /// <para>Name: My Monthly Total</para>
        /// <para>Internal: stat_my_this_month</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("stat_my_this_month")]
        [OdooField("stat_my_this_month")]
        public int StatMyThisMonth { get; set; }

        /// <summary>
        /// <para>Name: My Monthly Sending Total</para>
        /// <para>Internal: stat_my_monthly_sending</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("stat_my_monthly_sending")]
        [OdooField("stat_my_monthly_sending")]
        public int StatMyMonthlySending { get; set; }

        /// <summary>
        /// <para>Name: Remaining Sending Allowed</para>
        /// <para>Internal: remaining_sending</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("remaining_sending")]
        [OdooField("remaining_sending")]
        public int RemainingSending { get; set; }
        ...
        /// <summary>
        /// <para>Name: Survey Ids</para>
        /// <para>Internal: survey_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("survey_ids")]
        [OdooField("survey_ids")]
        ...
        /// <summary>
        /// <para>Name: Granted Employees Count</para>
        /// <para>Internal: granted_employees_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("granted_employees_count")]
        [OdooField("granted_employees_count")]
        public int GrantedEmployeesCount { get; set; }
