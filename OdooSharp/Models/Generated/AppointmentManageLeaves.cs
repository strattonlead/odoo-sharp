...
{
    [OdooModel("appointment.manage.leaves")]
    public partial class AppointmentManageLeaves
    {
        ...
        /// <para>Internal: leave_start_dt</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("leave_start_dt")]
        [JsonConverter(typeof(OdooDateTimeConverter))]
        [OdooField("leave_start_dt")]
        public DateTime? LeaveStartDt { get; set; }

        /// <summary>
        /// <para>Name: End Date</para>
        /// <para>Internal: leave_end_dt</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: DateTime</para>
        /// </summary>
        [JsonPropertyName("leave_end_dt")]
        [JsonConverter(typeof(OdooDateTimeConverter))]
        [OdooField("leave_end_dt")]
        public DateTime? LeaveEndDt { get; set; }
