...
{
    [OdooModel("appointment.question")]
    public partial class AppointmentQuestion
    {
        ...
        /// <para>Internal: question_required</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("question_required")]
        [OdooField("question_required")]
        ...
        /// <summary>
        /// <para>Name: Available Answers</para>
        /// <para>Internal: answer_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("answer_ids")]
        public List<int> AnswerIds { get; set; }

        /// <summary>
        /// <para>Name: Submitted Answers</para>
        /// <para>Internal: answer_input_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("answer_input_ids")]
        [OdooField("answer_input_ids")]
        public List<int> AnswerInputIds { get; set; }
