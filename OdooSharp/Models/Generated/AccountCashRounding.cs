...
{
    [OdooModel("account.cash.rounding")]
    public partial class AccountCashRounding
    {
        ...
        /// <summary>
        /// <para>Name: Rounding Strategy</para>
        /// <para>Internal: strategy</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Rounding Method</para>
        /// <para>Internal: rounding_method</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
