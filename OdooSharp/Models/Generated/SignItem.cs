...
namespace OdooSharp.Models
{
    ...
    public partial class SignItem
    {
        ...
        /// <summary>
        /// <para>Name: Type</para>
        /// <para>Internal: type_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: sign.item.type</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Radio button options</para>
        /// <para>Internal: radio_set_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: sign.item.radio.set</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Number of Radio Button options</para>
        /// <para>Internal: num_options</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Position X</para>
        /// <para>Internal: posX</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Position Y</para>
        /// <para>Internal: posY</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Alignment</para>
        /// <para>Internal: alignment</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
