...
namespace OdooSharp.Models
{
    ...
    public partial class ProductTag
    {
        ...
        /// <summary>
        /// <para>Name: Product Templates</para>
        /// <para>Internal: product_template_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: product_product_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: All Product Variants using this Tag</para>
        ...
        /// <summary>
        /// <para>Name: Visible on eCommerce</para>
        /// <para>Internal: visible_on_ecommerce</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
