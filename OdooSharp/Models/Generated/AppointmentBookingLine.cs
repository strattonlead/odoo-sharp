...
{
    [OdooModel("appointment.booking.line")]
    public partial class AppointmentBookingLine
    {
        ...
        /// <summary>
        /// <para>Name: Appointment Resource</para>
        /// <para>Internal: appointment_resource_id</para>
        /// <para>Store: yes</para>
        ...
        /// </summary>
        [JsonPropertyName("appointment_resource_id")]
        ...
        /// <summary>
        /// <para>Name: Capacity Reserved</para>
        /// <para>Internal: capacity_reserved</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("capacity_reserved")]
        public int CapacityReserved { get; set; }

        /// <summary>
        /// <para>Name: Capacity Used</para>
        /// <para>Internal: capacity_used</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Booking Start</para>
        /// <para>Internal: event_start</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Booking End</para>
        /// <para>Internal: event_stop</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
