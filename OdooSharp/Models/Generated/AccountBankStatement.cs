...
{
    [OdooModel("account.bank.statement")]
    public partial class AccountBankStatement
    {
        ...
        /// <summary>
        /// <para>Name: External Reference</para>
        ...
        /// <summary>
        /// <para>Name: First Line Index</para>
        /// <para>Internal: first_line_index</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("first_line_index")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string FirstLineIndex { get; set; }

        /// <summary>
        /// <para>Name: Starting Balance</para>
        /// <para>Internal: balance_start</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("balance_start")]
        public decimal BalanceStart { get; set; }

        /// <summary>
        /// <para>Name: Computed Balance</para>
        /// <para>Internal: balance_end</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Monetary</para>
        /// </summary>
        [JsonPropertyName("balance_end")]
        public decimal BalanceEnd { get; set; }

        /// <summary>
        /// <para>Name: Ending Balance</para>
        /// <para>Internal: balance_end_real</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Monetary</para>
        /// </summary>
        [JsonPropertyName("balance_end_real")]
        ...
        /// <summary>
        /// <para>Name: Statement lines</para>
        ...
        /// <para>Internal: is_complete</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Problem Description</para>
        /// <para>Internal: problem_description</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
