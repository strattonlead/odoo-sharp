...
namespace OdooSharp.Models
{
    ...
    public partial class HrWorkLocation
    {
        ...
        /// <summary>
        /// <para>Name: Cover Image</para>
        /// <para>Internal: location_type</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Location Number</para>
        /// <para>Internal: location_number</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
