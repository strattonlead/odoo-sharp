...
{
    [OdooModel("account.reconcile.model.partner.mapping")]
    public partial class AccountReconcileModelPartnerMapping
    {
        ...
        /// <summary>
        /// <para>Name: Find Text in Label</para>
        /// <para>Internal: payment_ref_regex</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("payment_ref_regex")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string PaymentRefRegex { get; set; }

        /// <summary>
        /// <para>Name: Find Text in Notes</para>
        /// <para>Internal: narration_regex</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("narration_regex")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
