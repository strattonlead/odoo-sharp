...
namespace OdooSharp.Models
{
    ...
    public partial class ResCountry
    {
        ...
        /// <summary>
        /// <para>Name: Layout in Reports</para>
        /// <para>Internal: address_format</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Input View</para>
        /// <para>Internal: address_view_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("address_view_id")]
        ...
        /// <summary>
        /// <para>Name: Country Calling Code</para>
        /// <para>Internal: phone_code</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Customer Name Position</para>
        /// <para>Internal: name_position</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: State Required</para>
        /// <para>Internal: state_required</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("state_required")]
        public bool StateRequired { get; set; }

        /// <summary>
        /// <para>Name: Zip Required</para>
        /// <para>Internal: zip_required</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
