...
namespace OdooSharp.Models
{
    ...
    public partial class PaymentMethod
    {
        ...
        /// <summary>
        /// <para>Name: Primary Payment Method</para>
        /// <para>Internal: primary_payment_method_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("primary_payment_method_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("primary_payment_method_id")]
        public int? PrimaryPaymentMethodId { get; set; }

        /// <summary>
        /// <para>Name: Brands</para>
        /// <para>Internal: brand_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Is Primary Payment Method</para>
        /// <para>Internal: is_primary</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("is_primary")]
        public bool IsPrimary { get; set; }

        /// <summary>
        /// <para>Name: Providers</para>
        /// <para>Internal: provider_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: The resized image displayed on the payment form.</para>
        /// <para>Internal: image_payment_form</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Binary</para>
        /// </summary>
        [JsonPropertyName("image_payment_form")]
        [JsonConverter(typeof(OdooByteArrayConverter))]
        [OdooField("image_payment_form")]
        public byte[] ImagePaymentForm { get; set; }
        ...
        /// <para>Internal: supported_country_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("supported_country_ids")]
        [OdooField("supported_country_ids")]
        public List<int> SupportedCountryIds { get; set; }

        /// <summary>
        /// <para>Name: Currencies</para>
        /// <para>Internal: supported_currency_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("supported_currency_ids")]
        [OdooField("supported_currency_ids")]
        public List<int> SupportedCurrencyIds { get; set; }
