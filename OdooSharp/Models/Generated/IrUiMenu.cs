...
namespace OdooSharp.Models
{
    ...
    public partial class IrUiMenu
    {
        ...
        /// <summary>
        /// <para>Name: Web Icon File</para>
        /// <para>Internal: web_icon</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Web Icon Image</para>
        /// <para>Internal: web_icon_data</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("web_icon_data")]
        [JsonConverter(typeof(OdooByteArrayConverter))]
        public byte[] WebIconData { get; set; }

        /// <summary>
        /// <para>Name: Invisible</para>
        /// <para>Internal: web_invisible</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("web_invisible")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string WebInvisible { get; set; }
        ...
        /// <summary>
        /// <para>Name: Studio Configuration Menu</para>
        /// <para>Internal: is_studio_configuration</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("is_studio_configuration")]
        public bool IsStudioConfiguration { get; set; }
