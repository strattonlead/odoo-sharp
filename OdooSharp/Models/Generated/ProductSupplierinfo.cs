...
{
    [OdooModel("product.supplierinfo")]
    public partial class ProductSupplierinfo
    {
        ...
        /// <summary>
        /// <para>Name: Vendor Product Name</para>
        /// <para>Internal: product_name</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("product_name")]
        public string ProductName { get; set; }

        /// <summary>
        /// <para>Name: Vendor Product Code</para>
        /// <para>Internal: product_code</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Discounted Price</para>
        /// <para>Internal: price_discounted</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Delivery Lead Time</para>
