...
{
    [OdooModel("choose.delivery.carrier")]
    public partial class ChooseDeliveryCarrier
    {
        ...
        /// <summary>
        /// <para>Name: Shipping Method</para>
        ...
        /// <summary>
        /// <para>Name: Delivery Price</para>
        /// <para>Internal: delivery_price</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("delivery_price")]
        public double DeliveryPrice { get; set; }

        /// <summary>
        /// <para>Name: Cost</para>
        /// <para>Internal: display_price</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Available Carriers</para>
        /// <para>Internal: available_carrier_ids</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: delivery.carrier</para>
        /// </summary>
        [JsonPropertyName("available_carrier_ids")]
        [OdooField("available_carrier_ids")]
        public List<int> AvailableCarrierIds { get; set; }

        /// <summary>
        /// <para>Name: Invoicing Message</para>
        /// <para>Internal: invoicing_message</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("invoicing_message")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("invoicing_message")]
        public string InvoicingMessage { get; set; }
        ...
        /// <summary>
        /// <para>Name: Total Order Weight</para>
        /// <para>Internal: total_weight</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("total_weight")]
        public double TotalWeight { get; set; }

        /// <summary>
        /// <para>Name: Weight Uom Name</para>
