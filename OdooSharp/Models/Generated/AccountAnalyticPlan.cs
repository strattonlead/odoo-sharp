...
{
    [OdooModel("account.analytic.plan")]
    public partial class AccountAnalyticPlan
    {
        ...
        /// <para>Relation: account.analytic.plan</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Children Plans Count</para>
        /// <para>Internal: children_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Analytic Accounts Count</para>
        /// <para>Internal: account_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: All Analytic Accounts Count</para>
        /// <para>Internal: all_account_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("all_account_count")]
        ...
        /// <summary>
        /// <para>Name: Default Applicability</para>
        /// <para>Internal: default_applicability</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        ...
        /// </summary>
        [JsonPropertyName("default_applicability")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string DefaultApplicability { get; set; }

        /// <summary>
        /// <para>Name: Applicability</para>
        /// <para>Internal: applicability_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: account.analytic.applicability</para>
        /// </summary>
        [JsonPropertyName("applicability_ids")]
