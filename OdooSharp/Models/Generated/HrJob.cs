...
namespace OdooSharp.Models
{
    ...
    public partial class HrJob
    {
        ...
        /// <summary>
        /// <para>Name: Total Forecasted Employees</para>
        /// <para>Internal: expected_employees</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("expected_employees")]
        [OdooField("expected_employees")]
        public int ExpectedEmployees { get; set; }

        /// <summary>
        /// <para>Name: Current Number of Employees</para>
        /// <para>Internal: no_of_employee</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("no_of_employee")]
        [OdooField("no_of_employee")]
        public int NoOfEmployee { get; set; }

        /// <summary>
        /// <para>Name: Target</para>
        /// <para>Internal: no_of_recruitment</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("no_of_recruitment")]
        [OdooField("no_of_recruitment")]
        ...
        /// <summary>
        /// <para>Name: Job Description</para>
        ...
        /// <summary>
        /// <para>Name: Requirements</para>
        /// <para>Internal: requirements</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Employment Type</para>
        /// <para>Internal: contract_type_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: hr.contract.type</para>
        /// </summary>
        [JsonPropertyName("contract_type_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("contract_type_id")]
