...
{
    [OdooModel("gamification.challenge")]
    public partial class GamificationChallenge
    {
        ...
        /// <summary>
        /// <para>Name: User domain</para>
        /// <para>Internal: user_domain</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Suggest to users</para>
        /// <para>Internal: invited_user_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: For Every Succeeding User</para>
        /// <para>Internal: reward_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: For 1st user</para>
        /// <para>Internal: reward_first_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: gamification.badge</para>
        /// </summary>
        [JsonPropertyName("reward_first_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        public int? RewardFirstId { get; set; }

        /// <summary>
        /// <para>Name: For 2nd user</para>
        /// <para>Internal: reward_second_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: gamification.badge</para>
        /// </summary>
        [JsonPropertyName("reward_second_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        public int? RewardSecondId { get; set; }

        /// <summary>
        /// <para>Name: For 3rd user</para>
        /// <para>Internal: reward_third_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: gamification.badge</para>
        /// </summary>
        [JsonPropertyName("reward_third_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        public int? RewardThirdId { get; set; }

        /// <summary>
        /// <para>Name: Reward Bests if not Succeeded?</para>
        /// <para>Internal: reward_failure</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("reward_failure")]
        public bool RewardFailure { get; set; }

        /// <summary>
        /// <para>Name: Reward as soon as every goal is reached</para>
        /// <para>Internal: reward_realtime</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("reward_realtime")]
        public bool RewardRealtime { get; set; }

        /// <summary>
        /// <para>Name: Display Mode</para>
        /// <para>Internal: visibility_mode</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Report Frequency</para>
        /// <para>Internal: report_message_frequency</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// </summary>
        [JsonPropertyName("report_message_frequency")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string ReportMessageFrequency { get; set; }

        /// <summary>
        /// <para>Name: Send a copy to</para>
        /// <para>Internal: report_message_group_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("report_message_group_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        public int? ReportMessageGroupId { get; set; }

        /// <summary>
        /// <para>Name: Report Template</para>
        /// <para>Internal: report_template_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Non-updated manual goals will be reminded after</para>
        ...
        /// <summary>
        /// <para>Name: Last Report Date</para>
        /// <para>Internal: last_report_date</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Next Report Date</para>
        /// <para>Internal: next_report_date</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Date</para>
        /// </summary>
        [JsonPropertyName("next_report_date")]
        [JsonConverter(typeof(OdooDateTimeConverter))]
        public DateTime? NextReportDate { get; set; }

        /// <summary>
        /// <para>Name: Appears in</para>
        /// <para>Internal: challenge_category</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// </summary>
        [JsonPropertyName("challenge_category")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
