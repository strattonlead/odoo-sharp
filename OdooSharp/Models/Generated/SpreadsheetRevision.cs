...
{
    [OdooModel("spreadsheet.revision")]
    public partial class SpreadsheetRevision
    {
        ...
        /// <summary>
        /// <para>Name: Commands</para>
        /// <para>Internal: commands</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Revision Uuid</para>
        /// <para>Internal: revision_uuid</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("revision_uuid")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string RevisionUuid { get; set; }

        /// <summary>
        /// <para>Name: Parent Revision</para>
        /// <para>Internal: parent_revision_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
