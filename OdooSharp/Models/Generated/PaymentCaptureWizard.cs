...
{
    [OdooModel("payment.capture.wizard")]
    public partial class PaymentCaptureWizard
    {
        ...
        /// <summary>
        /// <para>Name: Authorized Amount</para>
        /// <para>Internal: authorized_amount</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Already Captured</para>
        /// <para>Internal: captured_amount</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Already Voided</para>
        /// <para>Internal: voided_amount</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Maximum Capture Allowed</para>
        /// <para>Internal: available_amount</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Amount To Capture</para>
        /// <para>Internal: amount_to_capture</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        ...
        /// <summary>
        /// <para>Name: Is Amount To Capture Valid</para>
        /// <para>Internal: is_amount_to_capture_valid</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Void Remaining Amount</para>
        /// <para>Internal: void_remaining_amount</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Support Partial Capture</para>
        /// <para>Internal: support_partial_capture</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Has Draft Children</para>
        /// <para>Internal: has_draft_children</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Has Remaining Amount</para>
        /// <para>Internal: has_remaining_amount</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
