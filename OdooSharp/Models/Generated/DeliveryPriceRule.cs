...
namespace OdooSharp.Models
{
    ...
    public partial class DeliveryPriceRule
    {
        ...
        /// <summary>
        /// <para>Name: Variable</para>
        /// <para>Internal: variable</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Sale Base Price</para>
        /// <para>Internal: list_base_price</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Variable Factor</para>
        /// <para>Internal: variable_factor</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
