...
namespace OdooSharp.Models
{
    ...
    public partial class SignLog
    {
        ...
        /// <summary>
        /// <para>Name: Log Date</para>
        /// <para>Internal: log_date</para>
        /// <para>Store: yes</para>
        ...
        /// <summary>
        /// <para>Name: Sign Request Item</para>
        ...
        /// <summary>
        /// <para>Name: IP address of the visitor</para>
        /// <para>Internal: ip</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: User token</para>
        /// <para>Internal: token</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Action Performed</para>
        ...
        /// <summary>
        /// <para>Name: State of the request on action log</para>
        /// <para>Internal: request_state</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
