...
{
    [OdooModel("gamification.karma.rank")]
    public partial class GamificationKarmaRank
    {
        ...
        /// <summary>
        /// <para>Name: Motivational</para>
        /// <para>Internal: description_motivational</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Html</para>
        /// </summary>
        [JsonPropertyName("description_motivational")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        public string DescriptionMotivational { get; set; }

        /// <summary>
        /// <para>Name: Required Karma</para>
        /// <para>Internal: karma_min</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: # Users</para>
        /// <para>Internal: rank_users_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("rank_users_count")]
        public int RankUsersCount { get; set; }
