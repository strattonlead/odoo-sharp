...
namespace OdooSharp.Models
{
    ...
    public partial class ResCurrency
    {
        ...
        /// <summary>
        /// <para>Name: Currency numeric code.</para>
        /// <para>Internal: iso_numeric</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Symbol</para>
        /// <para>Internal: symbol</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Inverse Rate</para>
        /// <para>Internal: inverse_rate</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Rate String</para>
        /// <para>Internal: rate_string</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Rounding Factor</para>
        ...
        /// <summary>
        /// <para>Name: Decimal Places</para>
        /// <para>Internal: decimal_places</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Symbol Position</para>
        ...
        /// <summary>
        /// <para>Name: Currency Unit</para>
        /// <para>Internal: currency_unit_label</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Currency Subunit</para>
        /// <para>Internal: currency_subunit_label</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Is Current Company Currency</para>
        /// <para>Internal: is_current_company_currency</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Display Rounding Warning</para>
        /// <para>Internal: display_rounding_warning</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
