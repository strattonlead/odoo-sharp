...
namespace OdooSharp.Models
{
    ...
    public partial class AccountAnalyticLine
    {
        ...
        /// <para>Internal: unit_amount</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Allowed selection values: [other]=Other,[invoice]=Customer Invoice,[vendor_bill]=Vendor Bill</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Fiscal Year Search</para>
        /// <para>Internal: fiscal_year_search</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("fiscal_year_search")]
        [OdooField("fiscal_year_search")]
        public bool FiscalYearSearch { get; set; }
        ...
        /// <summary>
        /// <para>Name: Financial Account</para>
        /// <para>Internal: general_account_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("general_account_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("general_account_id")]
        public int? GeneralAccountId { get; set; }

        /// <summary>
        /// <para>Name: Financial Journal</para>
        ...
        /// <summary>
        /// <para>Name: Journal Item</para>
        /// <para>Internal: move_line_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("move_line_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("move_line_id")]
        ...
        /// <summary>
        /// <para>Name: Sales Order Item</para>
        /// <para>Internal: so_line</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
