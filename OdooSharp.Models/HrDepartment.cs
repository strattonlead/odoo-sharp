...
namespace OdooSharp.Models
{
    ...
    public partial class HrDepartment
    {
        ...
        /// <summary>
        /// <para>Name: Department Name</para>
        ...
        /// <summary>
        /// <para>Name: Parent Department</para>
        ...
        /// <summary>
        /// <para>Name: Child Departments</para>
        ...
        /// <summary>
        /// <para>Name: Has Read Access</para>
        /// <para>Internal: has_read_access</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("has_read_access")]
        [OdooField("has_read_access")]
        public bool HasReadAccess { get; set; }

        /// <summary>
        /// <para>Name: Total Employee</para>
        /// <para>Internal: total_employee</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("total_employee")]
        [OdooField("total_employee")]
        public int TotalEmployee { get; set; }

        /// <summary>
        /// <para>Name: Jobs</para>
        /// <para>Internal: jobs_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("jobs_ids")]
        [OdooField("jobs_ids")]
        public List<int> JobsIds { get; set; }

        /// <summary>
        /// <para>Name: Plan</para>
        /// <para>Internal: plan_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Plans Count</para>
        /// <para>Internal: plans_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Master Department</para>
        /// <para>Internal: master_department_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: hr.department</para>
        /// </summary>
        [JsonPropertyName("master_department_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("master_department_id")]
