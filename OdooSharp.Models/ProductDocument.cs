...
namespace OdooSharp.Models
{
    ...
    public partial class ProductDocument
    {
        ...
        /// <summary>
        /// <para>Name: Sale : Visible at</para>
        /// <para>Internal: attached_on_sale</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [hidden]=Hidden,[quotation]=On quote,[sale_order]=On confirmed order,[inside]=Inside quote pdf</para>
        /// </summary>
        [JsonPropertyName("attached_on_sale")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("attached_on_sale")]
        ...
        [OdooField("form_field_ids")]
        public List<int> FormFieldIds { get; set; }

        /// <summary>
        /// <para>Name: Publish on website</para>
        /// <para>Internal: shown_on_product_page</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("shown_on_product_page")]
        [OdooField("shown_on_product_page")]
