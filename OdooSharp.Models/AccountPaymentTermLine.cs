...
{
    [OdooModel("account.payment.term.line")]
    public partial class AccountPaymentTermLine
    {
        ...
        /// <summary>
        /// <para>Name: Due</para>
        /// <para>Internal: value_amount</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Display Days Next Month</para>
        /// <para>Internal: display_days_next_month</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Days on the next month</para>
        /// <para>Internal: days_next_month</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
