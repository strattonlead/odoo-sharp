...
{
    [OdooModel("mail.message.subtype")]
    public partial class MailMessageSubtype
    {
        ...
        /// <summary>
        /// <para>Name: Internal Only</para>
        /// <para>Internal: internal</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Hidden</para>
        /// <para>Internal: hidden</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Track Recipients</para>
        /// <para>Internal: track_recipients</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("track_recipients")]
        [OdooField("track_recipients")]
