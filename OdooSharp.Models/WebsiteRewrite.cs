...
namespace OdooSharp.Models
{
    ...
    public partial class WebsiteRewrite
    {
        ...
        /// <summary>
        /// <para>Name: URL from</para>
        /// <para>Internal: url_from</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: route_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: website.route</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: URL to</para>
        /// <para>Internal: url_to</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Allowed selection values: [404]=404 Not Found,[301]=301 Moved permanently,[302]=302 Moved temporarily,[308]=308 Redirect / Rewrite</para>
        /// </summary>
