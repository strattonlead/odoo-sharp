...
namespace OdooSharp.Models
{
    ...
    public partial class KnowledgeInvite
    {
        ...
        /// <summary>
        /// <para>Name: Have Share Partners</para>
        /// <para>Internal: have_share_partners</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("have_share_partners")]
        [OdooField("have_share_partners")]
        public bool HaveSharePartners { get; set; }
        ...
        /// <summary>
        /// <para>Name: Permission</para>
        /// <para>Internal: permission</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
