...
{
    [OdooModel("studio.approval.rule.delegate")]
    public partial class StudioApprovalRuleDelegate
    {
        /// <summary>
        /// <para>Name: ID</para>
        ...
        /// <summary>
        /// <para>Name: Approval Rule</para>
        /// <para>Internal: approval_rule_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: studio.approval.rule</para>
        /// </summary>
        [JsonPropertyName("approval_rule_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("approval_rule_id")]
