...
namespace OdooSharp.Models
{
    ...
    public partial class KnowledgeCover
    {
        ...
        /// <summary>
        /// <para>Name: Cover attachment</para>
        ...
        /// <summary>
        /// <para>Name: Articles using cover</para>
        /// <para>Internal: article_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("article_ids")]
        public List<int> ArticleIds { get; set; }

        /// <summary>
        /// <para>Name: Cover URL</para>
        /// <para>Internal: attachment_url</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
