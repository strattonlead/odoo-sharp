...
{
    [OdooModel("spreadsheet.cell.thread")]
    public partial class SpreadsheetCellThread
    {
        /// <summary>
        /// <para>Name: ID</para>
        ...
        /// <summary>
        /// <para>Name: Sale Order Spreadsheet</para>
        /// <para>Internal: sale_order_spreadsheet_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("sale_order_spreadsheet_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("sale_order_spreadsheet_id")]
        public int? SaleOrderSpreadsheetId { get; set; }
