...
namespace OdooSharp.Models
{
    ...
    public partial class ResourceResource
    {
        ...
        /// <summary>
        /// <para>Name: Type</para>
        /// <para>Internal: resource_type</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [user]=Human,[material]=Material</para>
        /// </summary>
        [JsonPropertyName("resource_type")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("resource_type")]
        ...
        /// <summary>
        /// <para>Name: Efficiency Factor</para>
        /// <para>Internal: time_efficiency</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
