...
{
    [OdooModel("account.merge.wizard")]
    public partial class AccountMergeWizard
    {
        /// <summary>
        /// <para>Name: ID</para>
        ...
        /// <summary>
        /// <para>Name: Group by name?</para>
        /// <para>Internal: is_group_by_name</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Wizard Line</para>
        /// <para>Internal: wizard_line_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Disable Merge Button</para>
        /// <para>Internal: disable_merge_button</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
