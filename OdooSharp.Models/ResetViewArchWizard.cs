...
{
    [OdooModel("reset.view.arch.wizard")]
    public partial class ResetViewArchWizard
    {
        ...
        /// <summary>
        /// <para>Name: Has Diff</para>
        /// <para>Internal: has_diff</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Architecture Diff</para>
        /// <para>Internal: arch_diff</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Reset Mode</para>
        /// <para>Internal: reset_mode</para>
        /// <para>Store: yes</para>
        ...
        /// <summary>
        /// <para>Name: Compare To View</para>
        /// <para>Internal: compare_view_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Arch To Compare To</para>
        /// <para>Internal: arch_to_compare</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
