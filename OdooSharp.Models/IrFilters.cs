...
namespace OdooSharp.Models
{
    ...
    public partial class IrFilters
    {
        ...
        /// <summary>
        /// <para>Name: Default Filter</para>
        /// <para>Internal: is_default</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Embedded Action</para>
        /// <para>Internal: embedded_action_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("embedded_action_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("embedded_action_id")]
        public int? EmbeddedActionId { get; set; }

        /// <summary>
        /// <para>Name: Embedded Parent Res</para>
        /// <para>Internal: embedded_parent_res_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("embedded_parent_res_id")]
        [OdooField("embedded_parent_res_id")]
