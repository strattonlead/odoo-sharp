...
{
    [OdooModel("studio.export.model")]
    public partial class StudioExportModel
    {
        /// <summary>
        /// <para>Name: ID</para>
        ...
        /// <summary>
        /// <para>Name: Fields to exclude</para>
        /// <para>Internal: excluded_fields</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("excluded_fields")]
        [OdooField("excluded_fields")]
        public List<int> ExcludedFields { get; set; }
        ...
        /// <para>Internal: records_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("records_count")]
        public string RecordsCount { get; set; }

        /// <summary>
        /// <para>Name: Demo</para>
        /// <para>Internal: is_demo_data</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("is_demo_data")]
        public bool IsDemoData { get; set; }

        /// <summary>
        /// <para>Name: Updatable</para>
        /// <para>Internal: updatable</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: include_attachment</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("include_attachment")]
        [OdooField("include_attachment")]
