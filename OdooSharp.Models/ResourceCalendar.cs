...
namespace OdooSharp.Models
{
    ...
    public partial class ResourceCalendar
    {
        ...
        /// <summary>
        /// <para>Name: Working Time</para>
        /// <para>Internal: attendance_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: resource.calendar.attendance</para>
        /// </summary>
        [JsonPropertyName("attendance_ids")]
        [OdooField("attendance_ids")]
        public List<int> AttendanceIds { get; set; }

        /// <summary>
        /// <para>Name: Time Off</para>
        /// <para>Internal: leave_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: resource.calendar.leaves</para>
        /// </summary>
        [JsonPropertyName("leave_ids")]
        [OdooField("leave_ids")]
        public List<int> LeaveIds { get; set; }

        /// <summary>
        /// <para>Name: Global Time Off</para>
        /// <para>Internal: global_leave_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: resource.calendar.leaves</para>
        /// </summary>
        [JsonPropertyName("global_leave_ids")]
        [OdooField("global_leave_ids")]
        public List<int> GlobalLeaveIds { get; set; }

        /// <summary>
        /// <para>Name: Average Hour per Day</para>
        /// <para>Internal: hours_per_day</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Explanation</para>
        /// <para>Internal: two_weeks_explanation</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("two_weeks_explanation")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("two_weeks_explanation")]
        public string TwoWeeksExplanation { get; set; }

        /// <summary>
        /// <para>Name: Flexible Hours</para>
        /// <para>Internal: flexible_hours</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("flexible_hours")]
        [OdooField("flexible_hours")]
        public bool FlexibleHours { get; set; }

        /// <summary>
        /// <para>Name: Hours per Week</para>
        /// <para>Internal: hours_per_week</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("hours_per_week")]
        public double HoursPerWeek { get; set; }

        /// <summary>
        /// <para>Name: Company Full Time</para>
        /// <para>Internal: full_time_required_hours</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Float</para>
        /// </summary>
        [JsonPropertyName("full_time_required_hours")]
        [OdooField("full_time_required_hours")]
        public double FullTimeRequiredHours { get; set; }

        /// <summary>
        /// <para>Name: Is Full Time</para>
        /// <para>Internal: is_fulltime</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("is_fulltime")]
        [OdooField("is_fulltime")]
        public bool IsFulltime { get; set; }

        /// <summary>
        /// <para>Name: Work Time Rate</para>
        /// <para>Internal: work_time_rate</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Float</para>
        /// </summary>
        [JsonPropertyName("work_time_rate")]
        [OdooField("work_time_rate")]
        public double WorkTimeRate { get; set; }

        /// <summary>
        /// <para>Name: Work Resources count</para>
        /// <para>Internal: work_resources_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("work_resources_count")]
        [OdooField("work_resources_count")]
        public int WorkResourcesCount { get; set; }
