...
namespace OdooSharp.Models
{
    ...
    public partial class IrCron
    {
        ...
        /// <summary>
        /// <para>Name: Server action</para>
        /// <para>Internal: ir_actions_server_id</para>
        /// <para>Store: yes</para>
        ...
        /// </summary>
        [JsonPropertyName("ir_actions_server_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("ir_actions_server_id")]
        public int? IrActionsServerId { get; set; }

        /// <summary>
        /// <para>Name: Name</para>
        /// <para>Internal: cron_name</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("cron_name")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("cron_name")]
        public string CronName { get; set; }

        /// <summary>
        /// <para>Name: Scheduler User</para>
        ...
        /// <summary>
        /// <para>Name: Interval Number</para>
        /// <para>Internal: interval_number</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("interval_number")]
        [OdooField("interval_number")]
        public int IntervalNumber { get; set; }

        /// <summary>
        /// <para>Name: Interval Unit</para>
        /// <para>Internal: interval_type</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [minutes]=Minutes,[hours]=Hours,[days]=Days,[weeks]=Weeks,[months]=Months</para>
        /// </summary>
        [JsonPropertyName("interval_type")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("interval_type")]
        public string IntervalType { get; set; }

        /// <summary>
        /// <para>Name: Next Execution Date</para>
        /// <para>Internal: nextcall</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Last Execution Date</para>
        /// <para>Internal: lastcall</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Failure Count</para>
        /// <para>Internal: failure_count</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("failure_count")]
        public int FailureCount { get; set; }

        /// <summary>
        /// <para>Name: First Failure Date</para>
        /// <para>Internal: first_failure_date</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: DateTime</para>
        /// </summary>
        [JsonPropertyName("first_failure_date")]
        [JsonConverter(typeof(OdooDateTimeConverter))]
        [OdooField("first_failure_date")]
