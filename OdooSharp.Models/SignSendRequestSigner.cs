...
{
    [OdooModel("sign.send.request.signer")]
    public partial class SignSendRequestSigner
    {
        ...
        /// <summary>
        /// <para>Name: Sign Send Request</para>
        /// <para>Internal: sign_send_request_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: sign.send.request</para>
        /// </summary>
        [JsonPropertyName("sign_send_request_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("sign_send_request_id")]
        public int? SignSendRequestId { get; set; }
