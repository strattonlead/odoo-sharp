...
namespace OdooSharp.Models
{
    ...
    public partial class DiscussChannel
    {
        ...
        /// <summary>
        /// <para>Name: Channel Type</para>
        /// <para>Internal: channel_type</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [chat]=Chat,[channel]=Channel,[group]=Group</para>
        /// </summary>
        [JsonPropertyName("channel_type")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("channel_type")]
        public string ChannelType { get; set; }

        /// <summary>
        /// <para>Name: Is Editable</para>
        /// <para>Internal: is_editable</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("is_editable")]
        public bool IsEditable { get; set; }

        /// <summary>
        /// <para>Name: Default Display Mode</para>
        /// <para>Internal: default_display_mode</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [video_full_screen]=Full screen video</para>
        /// </summary>
        [JsonPropertyName("default_display_mode")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("default_display_mode")]
        ...
        /// <summary>
        /// <para>Name: Avatar Cache Key</para>
        /// <para>Internal: avatar_cache_key</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("avatar_cache_key")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("avatar_cache_key")]
        public string AvatarCacheKey { get; set; }

        /// <summary>
        /// <para>Name: Partners</para>
        /// <para>Internal: channel_partner_ids</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: res.partner</para>
        /// </summary>
        [JsonPropertyName("channel_partner_ids")]
        [OdooField("channel_partner_ids")]
        public List<int> ChannelPartnerIds { get; set; }

        /// <summary>
        /// <para>Name: Members</para>
        ...
        /// <summary>
        /// <para>Name: Parent Channel</para>
        /// <para>Internal: parent_channel_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("parent_channel_id")]
        public int? ParentChannelId { get; set; }

        /// <summary>
        /// <para>Name: Sub Channels</para>
        /// <para>Internal: sub_channel_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: discuss.channel</para>
        /// </summary>
        [JsonPropertyName("sub_channel_ids")]
        [OdooField("sub_channel_ids")]
        public List<int> SubChannelIds { get; set; }

        /// <summary>
        /// <para>Name: From Message</para>
        /// <para>Internal: from_message_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("from_message_id")]
        public int? FromMessageId { get; set; }

        /// <summary>
        /// <para>Name: Pinned Messages</para>
        /// <para>Internal: pinned_message_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: mail.message</para>
        /// </summary>
        [JsonPropertyName("pinned_message_ids")]
        [OdooField("pinned_message_ids")]
        public List<int> PinnedMessageIds { get; set; }

        /// <summary>
        /// <para>Name: Sfu Channel Uuid</para>
        /// <para>Internal: sfu_channel_uuid</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Char</para>
        /// </summary>
        [JsonPropertyName("sfu_channel_uuid")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("sfu_channel_uuid")]
        ...
        /// <summary>
        /// <para>Name: Is Member</para>
        /// <para>Internal: is_member</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Self Member</para>
        /// <para>Internal: self_member_id</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: discuss.channel.member</para>
        /// </summary>
        [JsonPropertyName("self_member_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("self_member_id")]
        public int? SelfMemberId { get; set; }

        /// <summary>
        /// <para>Name: Invited Member</para>
        /// <para>Internal: invited_member_ids</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: discuss.channel.member</para>
        /// </summary>
        [JsonPropertyName("invited_member_ids")]
        [OdooField("invited_member_ids")]
        public List<int> InvitedMemberIds { get; set; }

        /// <summary>
        /// <para>Name: Member Count</para>
        /// <para>Internal: member_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Auto Subscription</para>
        ...
        /// <summary>
        /// <para>Name: Authorized Group</para>
        /// <para>Internal: group_public_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: res.groups</para>
        /// </summary>
        [JsonPropertyName("group_public_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("group_public_id")]
        public int? GroupPublicId { get; set; }

        /// <summary>
        /// <para>Name: Invitation URL</para>
        /// <para>Internal: invitation_url</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: HR Departments</para>
        /// <para>Internal: subscription_department_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("subscription_department_ids")]
        [OdooField("subscription_department_ids")]
        public List<int> SubscriptionDepartmentIds { get; set; }
