...
{
    [OdooModel("crm.lead.scoring.frequency")]
    public partial class CrmLeadScoringFrequency
    {
        ...
        /// <summary>
        /// <para>Name: Won Count</para>
        /// <para>Internal: won_count</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("won_count")]
        public double WonCount { get; set; }

        /// <summary>
        /// <para>Name: Lost Count</para>
        /// <para>Internal: lost_count</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
