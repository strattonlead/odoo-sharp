...
{
    [OdooModel("account.auto.reconcile.wizard")]
    public partial class AccountAutoReconcileWizard
    {
        ...
        /// <summary>
        /// <para>Name: Reconcile</para>
        /// <para>Internal: search_mode</para>
        /// <para>Store: yes</para>
        /// <para>Required: yes</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [one_to_one]=Perfect Match,[zero_balance]=Clear Account</para>
        /// </summary>
        [JsonPropertyName("search_mode")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("search_mode")]
