...
namespace OdooSharp.Models
{
    ...
    public partial class SurveyUserInput
    {
        ...
        /// <summary>
        /// <para>Name: Start date and time</para>
        ...
        /// <summary>
        /// <para>Name: End date and time</para>
        ...
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [new]=New,[in_progress]=In Progress,[done]=Completed</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Test Entry</para>
        /// <para>Internal: test_entry</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("test_entry")]
        [OdooField("test_entry")]
        public bool TestEntry { get; set; }

        /// <summary>
        /// <para>Name: Last displayed question/page</para>
        /// <para>Internal: last_displayed_page_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("last_displayed_page_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("last_displayed_page_id")]
        ...
        /// <summary>
        /// <para>Name: Attempts Count</para>
        /// <para>Internal: attempts_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        [OdooField("attempts_count")]
        public int AttemptsCount { get; set; }

        /// <summary>
        /// <para>Name: Attempt n°</para>
        /// <para>Internal: attempts_number</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("attempts_number")]
        [OdooField("attempts_number")]
        public int AttemptsNumber { get; set; }

        /// <summary>
        /// <para>Name: Survey Time Limit Reached</para>
        /// <para>Internal: survey_time_limit_reached</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("survey_time_limit_reached")]
        [OdooField("survey_time_limit_reached")]
        public bool SurveyTimeLimitReached { get; set; }

        /// <summary>
        /// <para>Name: Identification token</para>
        ...
        /// <summary>
        /// <para>Name: Invite token</para>
        /// <para>Internal: invite_token</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Predefined Questions</para>
        /// <para>Internal: predefined_question_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: survey.question</para>
        /// </summary>
        [JsonPropertyName("predefined_question_ids")]
        [OdooField("predefined_question_ids")]
        public List<int> PredefinedQuestionIds { get; set; }

        /// <summary>
        /// <para>Name: Score (%)</para>
        /// <para>Internal: scoring_percentage</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("scoring_percentage")]
        [OdooField("scoring_percentage")]
        public double ScoringPercentage { get; set; }

        /// <summary>
        /// <para>Name: Total Score</para>
        /// <para>Internal: scoring_total</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Float</para>
        /// </summary>
        [JsonPropertyName("scoring_total")]
        [OdooField("scoring_total")]
        public double ScoringTotal { get; set; }

        /// <summary>
        /// <para>Name: Quizz Passed</para>
        /// <para>Internal: scoring_success</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("scoring_success")]
        [OdooField("scoring_success")]
        public bool ScoringSuccess { get; set; }

        /// <summary>
        /// <para>Name: Survey First Submitted</para>
        /// <para>Internal: survey_first_submitted</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("survey_first_submitted")]
        [OdooField("survey_first_submitted")]
        public bool SurveyFirstSubmitted { get; set; }

        /// <summary>
        /// <para>Name: Is in a Session</para>
        /// <para>Internal: is_session_answer</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("is_session_answer")]
        [OdooField("is_session_answer")]
        public bool IsSessionAnswer { get; set; }

        /// <summary>
        /// <para>Name: Question Time Limit Reached</para>
        /// <para>Internal: question_time_limit_reached</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("question_time_limit_reached")]
        [OdooField("question_time_limit_reached")]
