...
{
    [OdooModel("sale.payment.provider.onboarding.wizard")]
    public partial class SalePaymentProviderOnboardingWizard
    {
        ...
        /// <para>Internal: payment_method</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [digital_signature]=Electronic signature,[stripe]=Credit & Debit card (via Stripe),[paypal]=PayPal,[manual]=Custom payment instructions</para>
        /// </summary>
        ...
        /// <para>Internal: paypal_email_account</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Internal: manual_name</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Bank Name</para>
        /// <para>Internal: journal_name</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Payment Instructions</para>
        /// <para>Internal: manual_post_msg</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name:  Data Fetched</para>
        /// <para>Internal: _data_fetched</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
