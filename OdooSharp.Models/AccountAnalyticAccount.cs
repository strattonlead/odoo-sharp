...
{
    [OdooModel("account.analytic.account")]
    public partial class AccountAnalyticAccount
    {
        ...
        /// <summary>
        /// <para>Name: Root Plan</para>
        /// <para>Internal: root_plan_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: account.analytic.plan</para>
        /// </summary>
        [JsonPropertyName("root_plan_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("root_plan_id")]
        ...
        /// <summary>
        /// <para>Name: Vendor Bill Count</para>
        /// <para>Internal: vendor_bill_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("vendor_bill_count")]
        [OdooField("vendor_bill_count")]
        public int VendorBillCount { get; set; }
