...
namespace OdooSharp.Models
{
    ...
    public partial class MailActivity
    {
        ...
        /// <para>Internal: activity_decoration</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("activity_decoration")]
        [JsonConverter(typeof(OdooFlexibleStringConverter))]
        [OdooField("activity_decoration")]
        public string ActivityDecoration { get; set; }
        ...
        /// <summary>
        /// <para>Name: Done Date</para>
        /// <para>Internal: date_done</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <summary>
        /// <para>Name: Automated activity</para>
        /// <para>Internal: automated</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [overdue]=Overdue,[today]=Today,[planned]=Planned,[done]=Done</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Name: Recommended Activity Type</para>
        /// <para>Internal: recommended_activity_type_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: mail.activity.type</para>
        /// </summary>
        [JsonPropertyName("recommended_activity_type_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("recommended_activity_type_id")]
        public int? RecommendedActivityTypeId { get; set; }

        /// <summary>
        /// <para>Name: Previous Activity Type</para>
        /// <para>Internal: previous_activity_type_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// <para>Relation: mail.activity.type</para>
        /// </summary>
        [JsonPropertyName("previous_activity_type_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("previous_activity_type_id")]
        public int? PreviousActivityTypeId { get; set; }

        /// <summary>
        /// <para>Name: Next activities available</para>
        /// <para>Internal: has_recommended_activities</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("has_recommended_activities")]
        [OdooField("has_recommended_activities")]
        public bool HasRecommendedActivities { get; set; }
        ...
        /// <summary>
        /// <para>Name: Calendar Meeting</para>
        ...
        /// <summary>
        /// <para>Name: Tax closing additional params</para>
        /// <para>Internal: account_tax_closing_params</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("account_tax_closing_params")]
        [JsonConverter(typeof(OdooFlexibleJsonObjectConverter))]
        [OdooField("account_tax_closing_params")]
        public object AccountTaxClosingParams { get; set; }
