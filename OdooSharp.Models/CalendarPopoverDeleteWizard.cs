...
{
    [OdooModel("calendar.popover.delete.wizard")]
    public partial class CalendarPopoverDeleteWizard
    {
        ...
        /// <para>Internal: delete</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Selection</para>
        /// <para>Allowed selection values: [one]=Delete this event,[next]=Delete this and following events,[all]=Delete all the events</para>
        /// </summary>
