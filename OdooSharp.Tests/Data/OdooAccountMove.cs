...
namespace OdooSharp.Tests.Data
{
    [OdooModel("account.move")]
    public partial class OdooAccountMove
    {
        /// <summary>
        /// <para>Name: ID</para>
        ...
        /// <summary>
        /// <para>Name: Expected Currency Rate</para>
        /// <para>Internal: expected_currency_rate</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("expected_currency_rate")]
        [OdooField("expected_currency_rate")]
        public double ExpectedCurrencyRate { get; set; }
        ...
        /// <summary>
        /// <para>Name: Stock Move</para>
        /// <para>Internal: stock_move_id</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Many2One</para>
        /// <para>Relation: stock.move</para>
        /// </summary>
        [JsonPropertyName("stock_move_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("stock_move_id")]
        public int? StockMoveId { get; set; }

        /// <summary>
        /// <para>Name: Stock Valuation Layer</para>
        /// <para>Internal: stock_valuation_layer_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: One2Many</para>
        /// <para>Relation: stock.valuation.layer</para>
        /// </summary>
        [JsonPropertyName("stock_valuation_layer_ids")]
        [OdooField("stock_valuation_layer_ids")]
        public List<int> StockValuationLayerIds { get; set; }
        ...
        /// <para>Internal: timesheet_ids</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("timesheet_ids")]
        [OdooField("timesheet_ids")]
        public List<int> TimesheetIds { get; set; }

        /// <summary>
        /// <para>Name: Number of timesheets</para>
        /// <para>Internal: timesheet_count</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("timesheet_count")]
        [OdooField("timesheet_count")]
        public int TimesheetCount { get; set; }

        /// <summary>
        /// <para>Name: Timesheet Encoding Unit</para>
        /// <para>Internal: timesheet_encode_uom_id</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        ...
        /// </summary>
        [JsonPropertyName("timesheet_encode_uom_id")]
        [JsonConverter(typeof(OdooMany2OneIdConverter))]
        [OdooField("timesheet_encode_uom_id")]
        public int? TimesheetEncodeUomId { get; set; }

        /// <summary>
        /// <para>Name: Timesheet Total Duration</para>
        /// <para>Internal: timesheet_total_duration</para>
        /// <para>Store: no</para>
        /// <para>Required: no</para>
        /// <para>Readonly: yes</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Integer</para>
        /// </summary>
        [JsonPropertyName("timesheet_total_duration")]
        [OdooField("timesheet_total_duration")]
        public int TimesheetTotalDuration { get; set; }

        /// <summary>
        /// <para>Name: Lieferadresse verbergen</para>
        /// <para>Internal: x_studio_hide_delivery_address</para>
        /// <para>Store: yes</para>
        /// <para>Required: no</para>
        /// <para>Readonly: no</para>
        /// <para>Company Dependent: no</para>
        /// <para>Field type: Boolean</para>
        /// </summary>
        [JsonPropertyName("x_studio_hide_delivery_address")]
        [OdooField("x_studio_hide_delivery_address")]
        public bool XStudioHideDeliveryAddress { get; set; }
